...
main (int argc, char *argv[])
{
  ...
  phy.EnableAsciiAll (ascii.CreateFileStream ("results/phy.tr"));
  csma.EnableAsciiAll(ascii.CreateFileStream ("results/csma.tr"));
  pointToPoint.EnableAsciiAll (ascii.CreateFileStream ("results/p2p.tr"));

  // AnimationInterface anim("results/anim.xml");
